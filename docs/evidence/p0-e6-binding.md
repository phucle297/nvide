...
- Calibration artifact: [`p0-e6-calibration-6c4542e.zip`](p0-e6-calibration-6c4542e.zip)
- Artifact SHA-256: `121d1a0a35a47c3b30c71933c22a3102def9f0719ca0a4d576ee73b6dca6c0ed`
- Artifact size: 168,035 bytes
...
| Eligible mode | 120 Hz configured; authority-observed 120.048019 Hz |
| Comparison mode | 60 Hz configured; authority-observed 60.021488 Hz |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 60 Hz | 1,196 | 1,190 | 6 | 16.6607000 ms | 17.3693000 ms | 60.021488 Hz |
| 120 Hz | 2,391 | 2,384 | 7 | 8.3300000 ms | 8.9897000 ms | 120.048019 Hz |

The median interval halves when the physical display changes from 60 to 120 Hz, while the same NVide workload, candidate binary, wgpu adapter, harness, authority version, and metric mode remain fixed. This demonstrates that the authority timestamps track display cadence rather than submission cadence. The eligible 120 Hz cadence is within P0.2's 119.5–120.5 Hz range. Its quarter-period is 2.0825000 ms, so the fixed 2 ms join tolerance remains below one quarter of the measured period.
...
for name in ("calibration-6c4542e-60", "calibration-6c4542e-120"):
...
## Superseded final exit-binding revalidation record

The clear natural-authority amendment changes the harness hash after these verdicts, so they are retained only as history.
